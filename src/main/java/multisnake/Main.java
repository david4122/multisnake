...
public class Main extends Application {
	...
	public void start(Stage stage) {
		...
		Snake s2 = new Snake(world, new Point(30, 10), 5, Direction.EAST);
		Snake s3 = new Snake(world, new Point(10, 30), 5, Direction.EAST);
		Snake s4 = new Snake(world, new Point(30, 30), 5, Direction.EAST);
		world.addSnake(s);
		world.addSnake(s2);
		world.addSnake(s3);
		world.addSnake(s4);
